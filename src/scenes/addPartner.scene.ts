...
export const addPartnerNameScene = new Scenes.BaseScene<MyContext>('addPartnerName');
export const addPartnerInnScene = new Scenes.BaseScene<MyContext>('addPartnerInn');
...
addPartnerNameScene.action(('exit'), async (ctx): Promise<void> => {
